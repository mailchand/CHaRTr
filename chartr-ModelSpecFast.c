...
int uDDMdSbSu(double *z, double *v, double *aU, double *aL, double *timecons, 
             double *usign, double *intercept, double *ieta, double *usign_var, double *usigneta, double *delay,
             double *s,double *dt,double *response,double *rt,double *n,double *maxTimeStep, 
             int *rangeLow, int *rangeHigh, double *randomTable)
{
  //   double t,rhs,x,hv,samplev;
...
int uDDMSbO(double *z, double *v, double *aU, double *aL, double *timecons, 
              double *usign, double *intercept, double *ieta, double *usign_var,
              double *s,double *dt,double *response,double *rt,double *n,double *maxTimeStep, 
              int *rangeLow, int *rangeHigh, double *randomTable)
{
...
int nluDDMd(double *z, double *v, double *aU, double *aL, double *timecons, 
           double *usign, double *intercept, double *usign_var,
...
int nluDDMSbSu(double *z, double *v, double *aU, double *aL, double *timecons, 
               double *usign, double *intercept, double *ieta, double *usign_var, double *usigneta,
               double *lambda, double *k,
               double *s,double *dt,double *response,double *rt,
               double *n,double *maxTimeStep,
               int *rangeLow, int *rangeHigh, double *randomTable)
{
  ...
  for (i=0;i<N;i++) {
    ...
    do 
    {
      ...
      // gamma = (*intercept + *usign_var*timeStep*(*dt));
      tCurr = (timeStep*(*dt))/1000.0;
      gamma = (sampleintercept + sampleSlope*(1-exp(-pow(tCurr/(*lambda),*k))));
      // This allows the specification of an increase in the momentary evidence over time.
      x = x+ ((*dt)*samplev+rhs*randomTable[returnRandomNumber(rangeL, rangeH)])*gamma;
...
int nluDDMSb(double *z, double *v, double *aU, double *aL, double *timecons, 
               double *usign, double *intercept, double *ieta, double *usign_var,
               double *lambda, double *k,
               double *s,double *dt,double *response,double *rt,
               double *n,double *maxTimeStep,
...
int ucDDM(double *z, double *v, double *aU, double *aL, double *timecons, 
          double *usign, double *intercept, double *usign_var, 
          double *lambda, double *aprime, double *k,
          double *s,double *dt,double *response,double *rt,double *n,double *maxTimeStep,
          int *rangeLow, int *rangeHigh, double *randomTable)
{
  //   double t,rhs,x,hv,samplev;
  double rhs,x,xu,samplev, gamma, currTime;   // xu stores x + urgency signal at each time point
  int N,i,timeStep,MaxTimeStep;
  double upper, lower;
...
// Like the UGM but no filtering and no time constants.
int uDDMd(double *z, double *v, double *aU, double *aL, double *timecons, 
         double *usign, double *intercept, double *usign_var, double *delay,
         double *s,double *dt,double *response,double *rt,double *n,double *maxTimeStep,
         int *rangeLow, int *rangeHigh, double *randomTable)
{
  //   double t,rhs,x,hv,samplev;
...
int uDDMdSvSb(double *z, double *v,double *eta, double *aU, double *aL, double *timecons, 
             double *usign, double *intercept, double *ieta, double *usign_var, double *delay,
             double *s,double *dt,double *response,double *rt,double *n,double *maxTimeStep, 
             int *rangeLow, int *rangeHigh, double *randomTable)
{
  //   double t,rhs,x,hv,samplev;
  double rhs,x,xu,samplev, sampleintercept, gamma;
  double tCurr;
  // xu stores x + urgency signal at each time point
  int N,i,timeStep,MaxTimeStep;
