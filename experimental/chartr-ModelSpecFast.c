...
int DDMs(double *z, double *v,double *aU, double *aL, double *s,double *dt,double *response,double *rt,double *n,double *maxTimeStep, int *rangeLow, int *rangeHigh, double *randomTable)
{
...
// Classical model from DDM et al. 1960
int DDM(double *z, double *v,double *aU, double *aL, double *s,double *dt,double *response,double *rt,double *n,double *maxTimeStep, int *rangeLow, int *rangeHigh, double *randomTable)
{
  //   double t,rhs,x,hv,samplev;
  double rhs,x;
  int N,i,timeStep,MaxTimeStep;
  ...
  for (i=0;i<N;i++) 
  {
    ...
    do 
    {
      ...
      x = x+(*dt)*(*v)+rhs*randomTable[returnRandomNumber(rangeL, rangeH)];
      if (x>=*aU) {
        response[i]=(double) 1.0; 
        break ;
      }
...
int UGM(double *z, double *v,double *aU, double *aL, double *timecons, double *usign, double *s,
           double *dt,double *response,double *rt,double *n,double *maxTimeStep)
{
  //   double t,rhs,x,hv,samplev;
