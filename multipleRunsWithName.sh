...
#$ -o logs/chartr-timingcs1-$TASK_ID.stdout
#$ -e logs/chartr-timingcs1-$TASK_ID.stderr
#$ -pe omp 28 
...
R CMD BATCH chartr-ClusterFits.r logs/R-${JOB_ID}-${SGE_TASK_ID}.Rout '--args folder="$1"'
